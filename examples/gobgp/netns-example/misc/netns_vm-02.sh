...
ip netns exec ns0 ip addr add 10.0.20.2/24 dev veth0
ip netns exec ns0 ip route add default via 10.0.20.1

# bridge gw
ifconfig bgp0_br 10.0.20.1 netmask 255.255.255.0 up
